           ...
           <div id="planos" class="container " style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
                      ...
                      <form id="msform">
                        ...
                        <fieldset>
                          ...
                          <br>
                          <div style="background-color:white; padding: 5px; border: 2px; ">
                            <p>Sua empresa possui mais de 6 meses?</p>
                            <p class="texto1" style="text-align: center;"><input type="checkbox" id="empresa6meses" /> <label for="empresa6meses">Sim, desejo Continuar</label>
                          </div>
