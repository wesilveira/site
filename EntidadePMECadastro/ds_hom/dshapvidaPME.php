...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Way.Digital - DS Hapvida PME</title>
	<style>
	/* reset de margens */
	* {
		margin: 0;
...
<br>
    ...
    <div class="container" style="margin-top:20px">
		...
		<div class="row">
			...
			<input type="hidden" name="name_form" value="Declaração de Saúde Hapvida PME" />
			<input type="hidden" name="id_form" value="dshapvidaPME" />
			</form>
		</div>
			<br>
			<br>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			//onload perguntas
			$.getJSON("perguntasHapvidaPME.json", function(data) {
				var question = "";
