...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="card mt-3 mb-3 col-12" style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
    ...
    <div id="planos" class="container " style="">
      <br><br><br>
      <p class="texto"><strong>Envio de Proposta</strong></p>
          <div id="accordion">
          <div class="card">
            ...
            <div id="collapseOne" class="collapse hide" aria-labelledby="heading2" data-parent="#accordion">
              <div class="card-body">
                <center>
                  <button type="button" class="btn btn-lg btn-success" id="btnE13">Finalizar Proposta</button>
                </center>
                <br>
                <br>
              </div>
