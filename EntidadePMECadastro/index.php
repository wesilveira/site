...
<!-- End Google Tag Manager (noscript) -->
  ...
  <!-- ======= Hero Section ======= -->
                  ...
                  <div class="card mt-3 mb-3 col-12" style="background-color:#e5f4fd; background-image: linear-gradient(#e5f4fd, #00639b);">
                    ...
                    <div id="planos" class="container " style="">
                    <br><br><br>
                      <p class="texto"><strong>Comece Aqui</strong></p>
                      <form id="msform">
                        <p class="texto1">Digite o CNPJ da sua empresa abaixo</p>
                        <fieldset>
                        <div class="input-group mb-2 mr-sm-2">
                          <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fa fa-user" style="width:20px;" title="CNPJ"></i></div>
                          </div>
                          <input type="text" class="form-control"  required="true" id="cnpj" maxLength="14" pattern="[0-9]*" inputmode="numeric" placeholder="CNPJ" title="CNPJ">
                        </div>
                        <br>
                        <br>
                        <input type="button" name="next" id="btnContinuaCadastroCNPJ" class="next action-button" value="Continuar">
                        </fieldset>
                      </form>
                  </div>
              </div>
