...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div id="planos" class="container " style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
    <br><br><br>
    <p class="texto"><strong>Cadastrar Empresa</strong></p>
    <form id="msform">
      <p class="texto1">Agora é necessário incluir todos os dados de sua empresa solicitados abaixo.</p>
      <fieldset>
      
       <div class="form-row">
        <div class="form-group col-md-12">
          <label for="cnpj" style="float: left;">CNPJ</label>
          <input type="text" class="form-control" id="cnpj" maxLength="14" pattern="[0-9]*" inputmode="numeric" placeholder="CNPJ" title="CNPJ">
        </div>
      </div>

       <div class="form-row">
        <div class="form-group col-md-12">
          <label for="razao_social" style="float: left;" >Razão Social</label>
          <input type="text" class="form-control" id="razao_social"  placeholder="Razão Social" title="Razão Social">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="nome_fantasia" style="float: left;" >Nome Fantasia</label>
          <input type="text" class="form-control" id="nome_fantasia"  placeholder="Nome Fantasia" title="Nome Fantasia">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="cep" style="float: left;" >CEP</label>
          <input type="text" class="form-control" id="cep"  placeholder="CEP" title="CEP">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="end" style="float: left;" >ENDEREÇO</label>
          <input type="text" class="form-control" id="end"  placeholder="ENDEREÇO" title="ENDEREÇO">
        </div>
      </div>
      <div class="form-row">
          <div class="form-group col-md-3">
          <label for="num" style="float: left;" >Número</label>
          <input type="text" pattern="[0-9]*" inputmode="numeric" class="form-control" id="numTit" placeholder="Número">
          </div>
          <div class="form-group col-md-9">
          <label for="comp" style="float: left;" >Complemento/Ponto de Referência</label>
          <input type="text" class="form-control" id="compTit" placeholder="Sala, Bloco, Andar, Casas, etc..." required>
          </div>
      </div>      
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="inc_est" style="float: left;" >Inscrição Estadual</label>
          <input type="text" class="form-control" id="inc_est"  placeholder="Inscrição Estadual" title="Inscrição Estadual">
        </div>
      </div>

     <div class="form-row">
        <div class="form-group col-md-12">
          <label for="inc_muni" style="float: left;" >Inscrição Municipal</label>
          <input type="text" class="form-control" id="inc_muni"  placeholder="Inscrição Municipal" title="Inscrição Municipal">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="tel" style="float: left;" >Telefone</label>
          <input type="text" class="form-control" id="tel" placeholder="Insira o Telefone" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" title="Celular com DDD">
        </div>
      </div>
     ...
     <div class="form-row">
        <div class="form-group col-md-12">
          <label for="nome_soc" style="float: left;" >Nome do Sócio</label>
          <input type="text" class="form-control" id="nome_soc"  placeholder="Nome do Sócio" title="Nome do Sócio">
        </div>
      </div>
           <div class="form-row">
        <div class="form-group col-md-12">
          <label for="cpf_soc" style="float: left;" >CPF do Sócio</label>
          <input type="text" pattern="[0-9]*" inputmode="numeric" maxlength="11" class="form-control" id="cpf_soc" placeholder="Insira o CPF do Sócio" required>
        </div>
      </div>

      <br>
      <br>
      <input type="button" name="next" id="btnCadastraEmpresa" class="next action-button" value="Continuar">
      <input type="button" name="next" id="btnCancelaCadastro" class="previous action-button-previous" value="Cancelar">
    </fieldset>
  </form>
</div>
</div>
