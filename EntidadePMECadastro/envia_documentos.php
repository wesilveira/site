...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div id="planos" class="container " style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
    <br><br><br>
    <p class="texto"><strong>Envio de Documentos</strong></p>
       <div class="container-fluid"> 
                <p align="center" class="texto11"><strong>Esta é uma etapa importante, leia as instruções abaixo.</strong></p>

                <p class="texto1" style="text-align: justify; text-justify: inter-word;">Aqui você vai anexar os documentos de sua empresa</p>
                ...
                <div id="accordion" style="margin-bottom:20px;margin-top:20px">
                        ...
                        <div class="row col-md-12">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="contractEmp"> Contrato Social ou Requerimento Empresarial ou Declaração de Firma Individual (MEI)</label>
                              <input type="file"  name="UF_CRM_1598111702929"  class="form-control-file"  id="contractEmp" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="cnpjEmp">Cartão do CNPJ</label>
                              <input type="file" name="UF_CRM_1598111765503" class="form-control-file" id="cnpjEmp" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="comprovanteEmp">Comprovante de endereço da empresa</label>
                              <input type="file"  name="UF_CRM_1598111783063" class="form-control-file"  id="comprovanteEmp" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="termoEmp">Termo de Adesão Allcare</label>
                              <input type="file" class="form-control-file" id="termoEmp"  name="UF_CRM_1598112168495">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="declarEmp">Para inclusão até 14 vidas, enviar declaração da empresa</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112211055" id="declarEmp" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="GFIPemp">Para inclusões a partir de 15 vidas, enviar GFIP completa</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112235959" id="GFIPemp" >
                            </div>
                          </div>
                            <div class="col-md-6">
                            <div class="form-group">
                              <label for="socContract">Contrato Social ou Requerimento de empresário ou Declaração de Firma Individual (MEI)</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112824040" id="socContract" required >
                            </div>
                          </div>
                          <br/>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingTwo">
                      <h5 class="mb-0">
                        <button type="button" class="btn btn-link collapsed acdTit" data-toggle="collapse" data-target="#collapse2" aria-expanded="true" aria-controls="collapse2">
                          Documentação Sócio
                        </button>
                      </h5>
                    </div>
                        ...
                        <div class="row col-md-12">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control-file" name="UF_CRM_1598112746904" id="cnhTit" disabled>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="comprovanteTit">Comprovante Residência</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112746904" id="comprovanteTit" disabled>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="rgfTit">RG Frente</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112746904" id="rgfTit" disabled>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="rgvTit">RG Verso</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112746904" id="rgvTit" disabled>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="cpffTit">CPF Frente</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112746904" id="cpffTit" disabled>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="cpfvTit">CPF Verso</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112746904" id="cpfvTit" disabled>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="rgvTit">Comprovante de Endreço</label>
                              <input type="file" class="form-control-file" name="UF_CRM_1598112143095" id="rgvTit" disabled>
                            </div>
                          </div>
                          <br/>
