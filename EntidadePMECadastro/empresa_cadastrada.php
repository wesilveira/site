...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div id="planos" class="container "  style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
    ...
    <form id="msform">
      <p class="texto1">Sua empresa já está cadastrada.</p>
      <p class="texto1">Para seguir com o fluxo de contratação de sua proposta clique abaixo em continuar.</p>

      <br/>
      <br/>
      <br/>
      <input type="button" name="next" onClick="localStorage.setItem('currentStep','5'); window.location.href = '../EntidadePMEFuncionario/5_ficha_titular.php'" class="next action-button" value="Continuar">
      <br/>
      <br/>
      <br/>
      <input type="button" name="next" onClick="window.location.href = 'index.php'" class="next action-button" value="Voltar">
