...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="card mt-3 mb-3 col-12" style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
    ...
    <div id="planos" class="container " style="">
      <br><br><br>
      <p class="texto"><strong>Proposta Enviada</strong></p>
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion" style="">
            <div class="card-body">
              ...
              <p class="texto1">Porém você já pode escolher o plano e cadastrar sócios e funcionários, clicando no botão abaixo:</p>
              <a href="#" class="botao1" onClick="localStorage.setItem('currentStep', 'beneficiario');localStorage.setItem('fluxo', 'beneficiario');window.location.href='../EntidadePMEFuncionario/beneficiario.php'">Inlcuir sócio ou Funcionário</a>
              </center>
            </div><br><br>
          </div>
    </div>
