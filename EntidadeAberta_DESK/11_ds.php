...
<!-- End Google Tag Manager (noscript) -->
  ...
  <!-- modal preenchimento dados iniciais fim --> 
        ...
        <div class="row">
          ...
          <iframe id="dsFrame" src="" height="500" width="1100" title="DS"></iframe>

          </div>
          <div class="corpo_resumo" id="corpo_resumo" style="display:none">

            <div class="container-fluid"> 
                <br><br><br><p class="texto1"><strong class="nomeTit"></strong>, pronto, sua Declaração foi enviada com sucesso.</p>
