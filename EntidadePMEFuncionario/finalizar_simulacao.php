...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TSVXJDT" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  ...
  <div style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);"">
    ...
    <div class="container-fluid">
      ...
      <br><br><br>
                <p class="texto"><strong>Finalizar Simulação</strong></p>
                <form id="msform">
                <p class="texto1">Sua simulação do plano está finalizada. Para contratar esta ou outra cotação de plano, sua empresa deve estar cadastrada.</p>
                <fieldset>
                  ...
                  <p class="texto0"><strong>Subtotal: <span class="subTotal"></span></strong></p>
                  <p class="texto1"></p>
                ...
                <input type="button" name="next"  class="next action-button" value="Cadastrar Empresa" style="cursor:pointer" onClick="cadastrarEmpresa()">
                <input type="button" name="next" id="btnCancelaSimulacao" class="previous action-button-previous" value="Voltar">
                <!--
                <p style="padding-top:20px">
                  <input type="button" class="btn btn-link" value="Já tem cadastro empresa? Clique aqui" onClick="window.location.href='empresa/login.php'" >
                </p>
-->
                </fieldset>
                </form>
  ...
  <div class="fixed-bottom col-12">
                  <table id="Tabela_01" width="338" height="64" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td>
                        <a href="#"><img src="imagens/r_05.png" width="53" height="51" alt=""></td></a>
                      <td>
