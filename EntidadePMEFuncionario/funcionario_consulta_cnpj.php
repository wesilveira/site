            ...
            <div class="row justify-content-center">
              ...
              <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-11 text-center p-0 mt-3 mb-2">
                  <div class="card mt-3 mb-3" style="background-color: #e6f1f7;">
                      ...
                      <form id="msform">                                                  
                          <div id="msformBody">
                            <p class="texto1">Agora, precisamos saber se sua empresa está cadastrada em nossa base.</p>
                            <p class="texto1">Abaixo entre com o CNPJ.</p>
                            ...
                            <fieldset style="padding-bottom:200px">
                              ...
                              <input type="button" name="next" id="btnConsultaCnpjFunc" class="next action-button" value="Continuar" >
                            </fieldset>
                          </div>
                          <div id="msgEmpresaNaoCadastrada" style="display:none">
