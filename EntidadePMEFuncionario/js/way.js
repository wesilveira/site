...
function cadastrarEmpresa(){
  if(localStorage.getItem('empresaCadastrada')){
                ...
                window.location.href = "5_ficha_titular.php";
                    ...
                    localStorage.setItem('veiodeSimu', true);

                    window.location.href='../EntidadePMECadastro/cadastro_f1.php'
                }
}
                ...
                success: function(result) {
                    ...
                    if(result.error === "false"){
                        ...
                        if(result.hasCompany){
                            ...
                            localStorage.setItem("empresaCadastrada", true);
