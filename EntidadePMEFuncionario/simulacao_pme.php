...
<?php include("../menu_top_mob.php"); ?>
  ...
  <!-- ======= Hero Section ======= -->
                  ...
                  <div class="card mt-3 mb-3 col-12" style="background-color:#e5f4fd; background-image: linear-gradient(#e5f4fd, #00639b);">

                      <p class="texto tituloEtapa">
                        <br><br><strong>Simular Plano de Saúde</strong></p>
                      <p class="texto1">Para iniciarmos a simulação do plano de saúde, precisamos dos dados abaixo.</p>
                      <form id="msform">                                                  
                          <fieldset>
                                  <div>                                                        
                                      <div class="inner">
                                  ...
                                  <input type="button" name="next" id="btnE1" class="next action-button" value="Simular Planos" >
                                  <input type="button" style="display:none" id="enviaForaAbragencia" class="action-button" value="Sim, desejo." >
                                    <a href="#"><font color="#ffffff">Sua Empresa já possue cadastro?</font></a>
                                  </fieldset>
                      </form>
                  </div>
