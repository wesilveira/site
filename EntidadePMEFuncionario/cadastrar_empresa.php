...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TSVXJDT" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  ...
  <div style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
    ...
    <div class="container-fluid">
      ...
      <br><br><br>
                      ...
                      <form id="msform">
                                  <p class="texto1">Agora iniciaremos o cadastro de sua empresa.</p>
                                  <p class="texto1">Assinale a resposta abaixo e clique em continuar.</p>
                                  <fieldset>

                                  <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                      <div class="input-group-text"><i class="fa fa-user" style="width:20px;" title="CNPJ Empresa"></i></div>
                                    </div>
                                    <input type="text" class="form-control" id="cnpj" maxLength="14" pattern="[0-9]*" inputmode="numeric" placeholder="CNPJ Empresa" title="CNPJ Empresa">
                                  </div>
                                  <br>
                                  <p>Sua empresa possui mais de 6 meses?</p>
                                  <p class="texto1"><input type="checkbox" id="empresa6meses" /> <label for="empresa6meses">Sim, possui mais de 6 meses.</label>
                                  <br>
                                  <input type="button" name="next" id="btnContinuaCadastro" class="next action-button" value="Continuar">
  ...
  <div class="fixed-bottom col-12">
                  <table id="Tabela_01" width="338" height="64" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td>
                        <a href="#"><img src="imagens/r_06.png" width="53" height="51" alt=""></td></a>
                      <td>
