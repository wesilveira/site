            ...
            <div class="row justify-content-center">
              ...
              <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-11 text-center p-0 mt-3 mb-2">
                  <div class="card mt-3 mb-3" style="background-color: #e6f1f7;">
                      <p class="texto"><strong>Comece aqui</strong></p>
                      <form id="msform">
                          <div>
                            <ul id="progressbar">
                          ...
                          <p class="texto1">É muito fácil escolher seu Plano de Saúde <strong>Way.Digital</strong></p>
                                ...
                                <fieldset style="padding-bottom:200px">
                                  ...
                                  <input type="button" name="next" id="btnFluxoSimulacao" class="next action-button" value="Simular Plano Empresa" >
                                  <input type="button" name="next" id="btnAcessoEmpresa" class="next action-button" value="Painel Empresa" >
                                  <input type="button" name="next" id="btnFluxoFuncionario" class="next action-button" value="Funcionário" >
