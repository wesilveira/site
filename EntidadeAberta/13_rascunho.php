...
<?php include("../menu_top_mob.php"); ?>
  ...
  <div class="modal" id="loading" style="display:block" id="modal-default">
    ...
    <div class="modal-content">
        ...
        <br><br><br><h4 class="modal-title"><img src="assets/img/favicon.png" width="40">&nbsp;<strong>Carregando</strong> <img width="100" src="assets/img/carregando.gif" alt="Carregando..." /></h4>
        </div>
            ...
            <div class="row">
                <div class="corpo_resumo">
                    ...
                    <div id="accordion">
                      ...
                      <br><br><br><button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
