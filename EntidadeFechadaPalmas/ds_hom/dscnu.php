...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Way.Digital - DS CNU</title>
	<style>
	/* reset de margens */
	* {
		margin: 0;
...
<br>
	...
	<div class="container">
		<div class="row">
			<h3 class="pt-4">DECLARAÇÃO DE SAÚDE</h3>
		</div>
		<div  class="row" align="justify">
			<B>A finalidade desta Declaração de Saúde é registrar &nbsp;todos os dados sobres as doenças ou lesões que o proponente titular e/ou seus(s) dependente(s) saiba(m) ser portador(es) ou sofredor(es), seja por diagnostico feito ou conhecido, e das quais tenha(m) conhecimento no momento da assinatura da proposta acima referida.</B> <br />
    ...
    <div class="container" style="margin-top:20px">
		...
		<div class="row">
			...
			<input type="hidden" name="numq" value="16" />
			<input type="hidden" name="name_form" value="Declaração de Saúde CNU" />
			<input type="hidden" name="id_form" value="dscnu" />
			</form>
		</div>
			<br>
			<br>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			//onload perguntas
			$.getJSON("perguntasdscnu.json", function(data) {
				var question = "";
