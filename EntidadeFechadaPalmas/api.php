    ...
    switch($tipo){
      ...
      case "buscaPlanos":
        ...
        if(isset($_POST["payload"]))
        {
          ...
          $buscaOperadoras = mysqli_query($conexao,"select * from operadoras where entidade_id = ".$entidade_id);
      ...
      case "geraRascunho":
        if(isset($_POST["deal_id"]) and $_POST["deal_id"] != "")
        {
          ...
          $template = $docsId['uf']['default']['rascunho'];
      ...
      case "geraProposta":
        if(isset($_POST["deal_id"]) and $_POST["deal_id"] != "")
        {
          ...
          $template = $docsId['uf']['default']['proposta'];
