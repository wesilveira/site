            ...
            <div class="row justify-content-center">
              ...
              <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-11 text-center p-0 mt-3 mb-2">
                  <div class="card mt-3 mb-3" style="background-color: #e6f1f7;">
                      <p class="texto"><strong>Resumo dos Planos</strong></p>
                      <form id="msform">
                          <div>
                            <ul id="progressbar">
                          ...
                          <p class="texto1 msgIncDep">Este plano de saúde que escolheu lhe permite adicionar familiares e/ou dependentes legais (cônjuge e filhos). Se desejar incluir dependentes, insira a <strong>data de nascimento</strong> e clique em incluir. Você pode incluir até 5 dependentes.</p>
                                  ...
                                  <div>                                                        
                                      ...
                                      <input type="button" name="next" id="btnSemDependente" class="next btn btn-primary" style="background:#006da8 !IMPORTANT" value="Prosseguir sem dependentes.">
                                      <input style="display:none;background:#006da8 !IMPORTANT" type="button" name="next" id="btnEncerraAddDep" class="next btn btn-primary" value="Pronto.">
                                      <br><br>
                                    </div>	
