...
var o=/^[0-9]+$/.test(i),u=/^[0-9]+\.[0-9]+$/.test(i),a=u?(i.split(".")[1]||[]).length:0;for(var f=n;f>=1;f--)
{var l=parseInt(i/n*f);u&&(l=parseFloat(i/n*f).toFixed(a));if(s)while(/(\d+)(\d{4})/.test(l.toString()))l=l.toString().replace(/(\d+)(\d{4})/,"$1,$2");e.unshift(l)}t.data("counterup-nums",e);t.text("0");
